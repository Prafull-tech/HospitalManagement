...
const DYNAMIC_TITLES: { pattern: RegExp; title: string }[] = [
  ...
  { pattern: /^\/profile\/change-password/, title: 'Change Password' },
  ...
  { pattern: /^\/billing\/ipd/, title: 'IPD Billing' },
  { pattern: /^\/billing\/corporate/, title: 'Corporate Billing' },
  { pattern: /^\/billing\/emi/, title: 'EMI Billing' },
  { pattern: /^\/billing\/payment\/online/, title: 'Online Payment' },
  { pattern: /^\/billing\/opd\/group/, title: 'OPD Group Bill' },
  { pattern: /^\/billing\/tpa/, title: 'Insurance / TPA' },

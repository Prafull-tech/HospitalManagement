...
export const SIDEBAR_MENU_GROUPS: SidebarMenuGroup[] = [
  ...
  },
  {
    ...
    allowedRoles: ['DOCTOR'],
    items: [
      { id: 'doctor-dash', label: 'Dashboard', route: '/doctor/dashboard', end: true, icon: 'LayoutDashboard', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-appts', label: 'My Appointments', route: '/doctor/appointments', end: true, icon: 'Calendar', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-opd-queue', label: 'OPD Queue', route: '/doctor/opd-queue', end: true, icon: 'Queue', allowedRoles: ['DOCTOR'], moduleCode: 'OPD' },
      { id: 'doctor-consultations', label: 'Consultations', route: '/doctor/consultations', end: true, icon: 'Stethoscope', allowedRoles: ['DOCTOR'], moduleCode: 'OPD' },
      { id: 'doctor-prescriptions', label: 'Prescriptions', route: '/doctor/prescriptions', end: true, icon: 'Pill', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-lab', label: 'Lab Requests & Results', route: '/doctor/lab', end: true, icon: 'FlaskConical', allowedRoles: ['DOCTOR'], moduleCode: 'LAB' },
      { id: 'doctor-ipd', label: 'IPD (Inpatients)', route: '/doctor/ipd', end: true, icon: 'Bed', allowedRoles: ['DOCTOR'], moduleCode: 'IPD' },
      { id: 'doctor-patients', label: 'Patient Records', route: '/doctor/patients', end: true, icon: 'Users', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-emr', label: 'Medical Records (EMR)', route: '/doctor/emr', end: true, icon: 'FileText', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-reports', label: 'Reports', route: '/doctor/reports', end: true, icon: 'BarChart', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-notifications', label: 'Notifications', route: '/doctor/notifications', end: true, icon: 'AlertCircle', allowedRoles: ['DOCTOR'] },
      { id: 'doctor-settings', label: 'Profile / Settings', route: '/doctor/settings', end: true, icon: 'Settings', allowedRoles: ['DOCTOR'] },
    ],
  },
  {
    id: 'front-office',
  ...
  },
  {
    ...
    items: [
      { id: 'pf-opd', label: 'OPD Visits', route: '/patient-flow/opd', end: true, icon: 'ClipboardList', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'OPD' },
      { id: 'pf-token-panel', label: 'Doctor Token Panel', route: '/opd/tokens', end: true, icon: 'Queue', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'OPD' },
      { id: 'pf-consultation', label: 'Doctor Consultation', route: '/patient-flow/consultation', end: true, icon: 'Stethoscope', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'OPD' },
      {
        id: 'pf-doctor-orders',
        label: 'Doctor Orders',
        icon: 'ClipboardList',
        allowedRoles: ['ADMIN', 'NURSE'],
        children: [
          { id: 'pf-lab-orders', label: 'Lab Orders', route: '/patient-flow/lab-orders', end: true, icon: 'FlaskConical', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'LAB' },
          { id: 'pf-radiology-orders', label: 'Radiology Orders', route: '/patient-flow/radiology-orders', end: true, icon: 'ScanLine', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'RADIOLOGY' },
          { id: 'pf-pharmacy-orders', label: 'Pharmacy Orders', route: '/patient-flow/pharmacy-orders', end: true, icon: 'Pill', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'PHARMACY' },
        ],
      },
      { id: 'pf-admission', label: 'Admission (IPD)', route: '/patient-flow/admission', end: true, icon: 'UserPlus', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'IPD' },
      { id: 'pf-bed-allocation', label: 'Bed Allocation', route: '/patient-flow/bed-allocation', end: true, icon: 'Bed', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'IPD' },
      { id: 'pf-treatment', label: 'Treatment Management', route: '/patient-flow/treatment', end: true, icon: 'Heart', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'NURSING' },
      { id: 'pf-transfer', label: 'Transfer / Bed Change', route: '/ipd/beds', end: true, icon: 'Bed', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'IPD' },
      { id: 'pf-discharge', label: 'Discharge Management', route: '/patient-flow/discharge', end: true, icon: 'FileText', allowedRoles: ['ADMIN', 'NURSE'], moduleCode: 'IPD' },
    ],
  },
  {
    id: 'pharmacy',

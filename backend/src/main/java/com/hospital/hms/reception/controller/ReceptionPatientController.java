...
public class ReceptionPatientController {
    ...
    @PatchMapping("/by-id/{id}/disable")
    public ResponseEntity<PatientResponseDto> disable(@PathVariable Long id) {
        PatientResponseDto updated = patientService.setActive(id, false);
        return ResponseEntity.ok(updated);
    }

    @PatchMapping("/by-id/{id}/enable")
    public ResponseEntity<PatientResponseDto> enable(@PathVariable Long id) {
        PatientResponseDto updated = patientService.setActive(id, true);
        return ResponseEntity.ok(updated);
    }
